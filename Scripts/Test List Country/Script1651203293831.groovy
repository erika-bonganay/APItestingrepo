...
response1 = WS.sendRequest(findTestObject('Country Info Service XML/ListCountries'))
...
WS.sendRequestAndVerify(findTestObject('Country Info Service XML/GetCapital', [('countryISOCode') : GlobalVariable.countryISOCode]))
